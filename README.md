...
1. What is the link of the fork OSProject in your repository. ***(1 mark)*** __https://github.com/NrIrdina/OSProjectDinaTrial)__.
2. How many files and folders are in this repository. ***(1 mark)*** __1 Image folder and 1 README file__.
...
1. Run the command **pwd** . ***(1 mark)*** _/workspaces/OSProjectDinaTrial_.
...
12. What is the available disk space mounted on /workspace. ***(1 mark)*** : __6.0Gi__.

13. Name the version and hardware architecture of the linux Virtual environment. ***(1 mark)*** __Linux codespaces-ea9b04 6.5.0-1025-azure #26~22.04.1-Ubuntu SMP Thu Jul 11 22:33:04 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux__.

14. What is the difference between **ls** vs **ls -asl**. ***(1 mark)*** : __ls is to lists all files in current directory. ls -asl is to lists all files including the hidden files in a long format with size.__.

15. What is the TLB size of the Virtual CPU. ***(1 mark)*** __2560 4K pages__.

16. What is the CPU speed of the Virtual CPU. ***(1 mark)*** __The info of the CPU speed can get by command cat /proc/cpuinfo. the CPU speed is 3232.350 MHz (processor 0) and 3234.756 (processor 1).__.

17. What is the top running process that consumes the most CPU cycles. ***(1 mark)*** __To find the top running process can be know by using command top.The top running process is node with PID 6266, using 1.0% CPU and 4.1% memory. A second node process (PID 2737) is also running, using 0.7% CPU and 0.8% memory.__.
